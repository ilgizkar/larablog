            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form id="deletePost_{{ $comment->id }}" action="{{ route('adminDeleteComment', $comment->id) }}" method="POST" style="display: contents">
                            @csrf
                            <button title="Удалить комментарий" class="btn btn-danger" type="submit">Удалить</button>
                        </form>
                    </div>
                </div>
            </div>
