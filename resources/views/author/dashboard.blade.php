                    ...
                    <div class="card p-4">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <span class="font-weight-light">Постов за сегодня</span>
                            </div>
                    ...
                    <div class="card p-4">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <span class="font-weight-light">Всего постов</span>
                            </div>
                    ...
                    <div class="card p-4">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <span class="font-weight-light">Комментарии за сегодня</span>
                            </div>
                    ...
                    <div class="card p-4">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <span class="font-weight-light">Все комментарии</span>
                            </div>
