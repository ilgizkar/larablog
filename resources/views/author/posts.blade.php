                            ...
                            <table class="table table-striped">
                                ...
                                @foreach(Auth::user()->posts as $post)
                                    <tr>
                                        ...
                                        <td>
                                            <a title="Редактировать пост" href="{{ route('showUpdatePost', $post->id) }}" class="btn btn-sm btn-success">Редактировать</a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form id="deletePost_{{ $post->id }}" action="{{ route('deletePost', $post->id) }}" method="POST" style="display: contents">
                            @csrf
